...
if __name__ == '__main__':
	...
	plt.plot(range(epoch_number+1), train_losses, label='Train')
	plt.plot(range(epoch_number+1), test_losses, label='Test')
	plt.xlabel('Epoch')
	plt.ylabel('Loss')
	plt.legend()
	plt.title('Loss')
	...
	plt.figure(figsize=(10, 5))
	plt.plot(range(epoch_number+1), train_f1_scores, label='Train')
	plt.plot(range(epoch_number+1), test_f1_scores, label='Test')
	plt.xlabel('Epoch')
	plt.ylabel('F1 Score')
	plt.legend()
	plt.title('F1 Score')
	...
	plt.figure(figsize=(10, 5))
	plt.plot(range(epoch_number+1), train_auc_scores, label='Train')
	plt.plot(range(epoch_number+1), test_auc_scores, label='Test')
	plt.xlabel('Epoch')
	...
	plt.figure(figsize=(10, 5))
	plt.plot(range(epoch_number+1), savgol_filter(train_losses, window_length=6, polyorder=3), label='Train')
	plt.plot(range(epoch_number+1), savgol_filter(test_losses, window_length=6, polyorder=3), label='Test')
	plt.xlabel('Epoch')
	plt.ylabel('Loss')
	plt.legend()
	plt.title('Loss')
	...
	plt.figure(figsize=(10, 5))
	plt.plot(range(epoch_number+1), savgol_filter(train_f1_scores, window_length=6, polyorder=3), label='Train')
	plt.plot(range(epoch_number+1), savgol_filter(test_f1_scores, window_length=6, polyorder=3), label='Test')
	plt.xlabel('Epoch')
	plt.ylabel('F1 Score')
	plt.legend()
	plt.title('F1 Score')
	...
	plt.figure(figsize=(10, 5))
	plt.plot(range(epoch_number+1), savgol_filter(train_auc_scores, window_length=6, polyorder=3), label='Train')
	plt.plot(range(epoch_number+1), savgol_filter(test_auc_scores, window_length=6, polyorder=3), label='Test')
	plt.xlabel('Epoch')
	plt.ylabel('AUC Score')
	plt.legend()
	plt.title('AUC Score')
